...
public class Imageclk {
	...
	Method Name: findmore

	Method Description : This Method does the function of clicking on "Find more button" 
	...
	****************************************************/
	...
	public static WebElement img(WebDriver driver) throws IOException 
	{
		...
		obje.load(fr2);
		el =driver.findElement(By.xpath(obje.getProperty("img")));
		return el;	
	}
